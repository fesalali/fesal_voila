<?php namespace App\Http\Controllers;
	...
	class AdminServicesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Title Ar','name'=>'title_ar','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Image','name'=>'image','type'=>'filemanager','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Image Home Page','name'=>'image_home_page','type'=>'filemanager','width'=>'col-sm-9'];
			...
			//$this->form[] = ['label'=>'Image Home Page','name'=>'image_home_page','type'=>'filemanager','width'=>'col-sm-9'];
			//$this->form[] = ['label'=>'Text En','name'=>'text_en','type'=>'wysiwyg','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Text Ar','name'=>'text_ar','type'=>'wysiwyg','width'=>'col-sm-10','dataenum'=>'1|yes;0|no'];
			//$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','validation'=>'required','width'=>'col-sm-10'];
			# OLD END FORM
