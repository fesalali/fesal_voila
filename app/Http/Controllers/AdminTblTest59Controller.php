<?php namespace App\Http\Controllers;
	...
	class AdminTblTest59Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Lang Id","name"=>"lang_id","join"=>"languages,name"];
			...
			$this->form[] = ['label'=>'Active','name'=>'active','type'=>'radio','width'=>'col-sm-10','dataenum'=>'1|yes;|no'];
			$this->form[] = ['label'=>'Lang Id','name'=>'lang_id','type'=>'select2','width'=>'col-sm-10'];
