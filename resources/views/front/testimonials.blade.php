                        ...
                        <div class="o-grid u-align-center service-sec">
                            <div class="o-cell-28@sm o-cell-20@md o-cell-16@lg">
                                <div class="o-content o-content--center">
                                    <h1 class="o-page__title o-h2 js-loader-title js-transition-title">testimonials</h1>
                                </div>

                                <div id="da-slider" class="da-slider">
                                @foreach($data["testimonials"] as $key=>$service)
                                <div class="da-slide" style="{{$key==0?'display: flex;align-items: center':''}}">
                                    <h2>{{$service->title}}</h2>
