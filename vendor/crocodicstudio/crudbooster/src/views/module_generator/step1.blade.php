        ...
        <div class="box-body">
            <form method="post" action="{{Route('ModulsControllerPostStep2')}}">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="">Has List Images</label>
                    <!-- fesal -->
                ...
                <div class="form-group">
                    <label for="">has page for client</label>
                    <!-- fesal -->
                    <select name="has_page_client" id="has_page_client" required class=" form-control">
                            <option {{($row->has_page_client ==1)?'selected':''}} value="1">Yes</option>
                            <option {{($row->has_page_client==0)?'selected':''}} value="0">No</option>
                    </select>
                </div>
                <div class="form-group">
                <label>Main Filed</label>
                <input class="form-control" name="main_field" value="{{$row->main_field}}">
                </div>
                 <div class="form-group">
                    <label for="">language effected</label>
                    <!-- fesal -->
                    <select name="lang_effected" id="lang_effected" required class=" form-control">
                            <option {{($row->lang_effected =='record')?'selected':''}} value="record">on record</option>
                            <option {{($row->lang_effected=='field')?'selected':''}} value="field">on field</option>
                    </select>
                </div>
